...
const LibraryScreen: React.FC<{ userProfile: UserProfile; onUpgradeRequest: () => void }> = ({ userProfile, onUpgradeRequest }) => {
    ...
    const resources = [
        ...
        { title: 'Nutrition for People Living with Cancer', category: 'Nutrition Guide', readTime: '50 min', icon: BookIcon, color: 'text-teal-500', pdfUrl: 'https://nutrican-store.sfo3.digitaloceanspaces.com/books/nutrition-and-cancer-booklet.pdf' },
    ];
...
/* --- RESERVED CODE FOR FUTURE ACTIVATION ---
const LiveScreenActive: React.FC<{ userProfile: UserProfile; onUpgradeRequest: () => void }> = ({ userProfile, onUpgradeRequest }) => {
